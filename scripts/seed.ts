...
async function main() {
  ...
  await prisma.thriftSubscription.deleteMany();
  await prisma.thriftPackage.deleteMany();
  await prisma.nextSettlementAccount.deleteMany();
  await prisma.paidSettlementAccount.deleteMany();
  await prisma.settlementClearance.deleteMany();
  ...
  console.log("   - 3 Settlement clearance records");
  console.log("   - 3 Paid settlement records");
  console.log("   - 3 Next settlement records");
  console.log("   - 4 Thrift packages");
  console.log("   - 3 Thrift subscriptions\n");
}
